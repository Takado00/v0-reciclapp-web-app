...
export default async function TodasLasConversacionesPage() {
      ...
      <div className="container py-8">
        <div className="max-w-md mx-auto bg-white dark:bg-gray-800 rounded-lg shadow p-6 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            Necesitas iniciar sesión para acceder a todas tus conversaciones.
          </p>
          <div className="flex justify-center gap-4">
            <a
              href="/login?redirect=/mensajes/todas"
